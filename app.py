...
TRANSLATIONS = {
    ...
    "zh": {
        ...
        "success": "成功",
        "select_unit": "选择单元",
        "select_content_type": "选择内容类型",
        "materials": "材料",
        "vocabulary": "词汇",
        "no_content_available": "没有可用内容",
        "content_type": "内容类型",
        "explore_mindmap": "探索思维导图",
        "mindmap_for_unit": "第{0}单元思维导图",
        "create_new_mindmap": "创建新思维导图",
        "ai_generated_mindmap": "AI生成的思维导图",
    ...
    "ar": {
        ...
        "explore_mindmap": "استكشف الخريطة الذهنية",
        "mindmap_for_unit": "خريطة ذهنية للوحدة {0}",
        "create_new_mindmap": "إنشاء خريطة ذهنية جديدة",
        "ai_generated_mindmap": "خريطة ذهنية مولدة بالذكاء الاصطناعي",
